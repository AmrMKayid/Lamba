...
//  this.httpClient.get('api/user/getUserInfo/'+this.currentUserID,
  ...
  getChildSchedule() {
    ...
    this.httpClient.get('api/schedule/getChildSchedule/' + this.currentUserID, this.httpOptions).subscribe((res: any) => {
