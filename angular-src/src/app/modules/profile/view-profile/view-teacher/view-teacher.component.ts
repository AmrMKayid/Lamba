...
export class ViewTeacherComponent implements OnInit {
  ...
  getChildrenForParent(){
    this.httpClient.get('api/user/myChildren', this.httpOptions).subscribe(
      (res: any) => {
  ...
  sendRequest(){
    ...
    this.httpClient.post('api/request/create/'+this.user._id +"/"+this.selectedChild ,dummy, this.httpOptions).subscribe(
      (res: any) => {
        new Noty({
          type: 'success',
